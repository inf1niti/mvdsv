...
#define HOOK_HOLD_SWING_TARGET_SCALE 0.70f
#define HOOK_HOLD_SWING_CAP 1.03f
#define HOOK_HOLD_SWING_ACCEL 0.18f
#define HOOK_HOLD_INWARD_CAP_SCALE 0.14f
#define HOOK_HOLD_REDIRECT_SCALE 0.52f
#define HOOK_HOLD_REDIRECT_CAP_SCALE 1.06f
